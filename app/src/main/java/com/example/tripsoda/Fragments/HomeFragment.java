package com.example.tripsoda.Fragments;
...
import com.example.tripsoda.Adapter.HomeViewAdapter;
...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        list = HomeItem.createContactsList(5);
        recyclerView.setHasFixedSize(true);
        adapter = new HomeViewAdapter(getActivity(), list);
